...
public class ConsolePrinter {
  ...
  private static final String CLIENT_OPERATION_PANEL = "Escolha um dos comandos abaixo:\n" +
      "  1. Criar conta\n" + "  2. Autenticar-se\n" +
  ...
  private static final String OVERWRITE_PRESS_ENTER = MOVE_TO_PREVIOUS_LINE + CLEAR_CURRENT_LINE
